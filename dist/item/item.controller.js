...
let ItemController = ItemController_1 = class ItemController {
    constructor(itemService) {
        this.itemService = itemService;
        this.logger = new my_logger_service_1.MyLoggerService(ItemController_1.name);
    }
    create(createItemDto) {
        return this.itemService.create(createItemDto);
    }
    findAll(ip) {
        this.logger.log(`Req User findAll()\t${ip}`, ItemController_1.name);
...
exports.ItemController = ItemController = ItemController_1 = __decorate([
